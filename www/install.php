    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4><a target="_blank" href="http://fanshub.org">BBS</a>系统安装</h4>
            </div>
            <div class="panel-body">
                <form action="install.php" method="POST">
                    ...
                    <input type="text" name="prefix" class="form-control" placeholder="表前缀默认为 bbs_">
            ...
            <div class="panel-footer">
                &copy; <?php echo date('Y'); ?> All rights reserved by <a target="_blank" href="http:/bbs.fanshub.org">BBS.</a>
            </div>
        </div>
        </div>
        </div>
